...
Coding tasks involved building the UI display to show users a detailed view of their analyzed projects after selecting a project card. Time was also spent preparing for peer evaluations. The plan for the future is to continue to build core frontend functionality to match the functionality of the backend meeting all the project requirements.
