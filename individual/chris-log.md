...
## T2 - Week 4-5 | 25 January - 08  February 2026
...
| Task | Status | Notes |
| :---- | :----- | :------- |
| In Class Demos | Completed | Conduct in class demos. |
| Bug Fixes  | Completed | Fixed minor bugs discovered from in-class demos. |
| Enhance R24 | In Progress | User role logic expanded to include taxonomy of constants. |
