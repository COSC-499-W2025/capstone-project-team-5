...
export default function AppShell({ page, setPage, apiOk, user, logout, onStartTour, onStartSetup }) {
  const current = getNavItem(page)
  const CurrentPage = getPageComponent(page)

  return (
    <div className="flex h-screen overflow-hidden bg-bg text-ink">
      <Sidebar current={page} onNav={setPage} apiOk={apiOk} user={user} onLogout={logout} onStartTour={onStartTour} onStartSetup={onStartSetup} />
